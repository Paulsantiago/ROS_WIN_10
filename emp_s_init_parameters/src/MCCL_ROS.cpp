...
void ROS_MCCL::initializePublishers()
{
    ...
    CurCpos_publisher_ = nh_.advertise<ros_basics_tutorial_mccl::CartesianPoint>("curcpos_MCCL", 1, true); 
...
int main (int argc, char **argv)
 {
	...
	ros_basics_tutorial_mccl::CartesianPoint tpoint ; 
	tpoint.X = 50 ; 
	tpoint.Y = 30; 
	tpoint.Z = 80; 
	tpoint.RX = 40;
	...
	//ros::Publisher mccl_pub = nh.advertise<ros_basics_tutorial_mccl::Point>("line_MCCL",1,true);
