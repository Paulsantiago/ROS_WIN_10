...
#include "ros_basics_tutorial_mccl/Joint.h"
#include <ros_basics_tutorial_mccl/CartesianPoint.h>
#include <conio.h>
 #include <stdio.h>
 #include <sstream>
using namespace std;
...
void movef(ros_basics_tutorial_mccl::CartesianPoint cPoint);

void getCurPosCallBack (const ros_basics_tutorial_mccl::CartesianPoint & pointMsg)
{
...
int main(int argc, char **argv)
{
    ...
    line_pub = nh.advertise<ros_basics_tutorial_mccl::CartesianPoint>("line_MCCL", 1, true); 
    ...
    ros_basics_tutorial_mccl::CartesianPoint cPoint ; 
